...
btnPlayer.addEventListener('click', function () {
  let player1Name = prompt('Enter Player 1:');
  let player2Name = prompt('Enter Player 2:');
  name1.innerHTML = player1Name ? player1Name : 'Player 1';
  name2.innerHTML = player2Name ? player2Name : 'Player 2';
});
